										...
										.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
												.addGroup(jPanel1Layout.createSequentialGroup()
														.addComponent(lblDescription, GroupLayout.PREFERRED_SIZE, 170,
																GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(jTextField_startDate, GroupLayout.PREFERRED_SIZE,
												...
												.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
														...
														.addPreferredGap(ComponentPlacement.RELATED)
														.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
																.addComponent(jTextField_totalPrice,
																		GroupLayout.PREFERRED_SIZE, 129,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(jTextField_provisional,
																		GroupLayout.PREFERRED_SIZE, 129,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(jTextField_host_id,
																		GroupLayout.PREFERRED_SIZE, 129,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(jTextField_booking_id,
																		GroupLayout.PREFERRED_SIZE, 129,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(jTextField_property_id,
																		GroupLayout.PREFERRED_SIZE, 129,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(jTextField_guest_id,
																		GroupLayout.PREFERRED_SIZE, 129,
																		GroupLayout.PREFERRED_SIZE)))))
